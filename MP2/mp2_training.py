...
dataset_list.append(Format_data(words_to_train, max_feat=None, dataset_name='Le - L - TF - 3g', n_gram=(1, 3), lemmatize=True, use_tf_idf=True, lang_id=True))
dataset_list.append(Format_data(words_to_train, max_feat=None, dataset_name='Le - L - TF - 2g', n_gram=(1, 2), lemmatize=True, use_tf_idf=True, lang_id=True))
...
dataset_list.append(Format_data(words_to_train, max_feat=None, dataset_name='Le - L - TF - 2g - PCA 100', n_gram=(1, 2), lemmatize=True, use_tf_idf=True, lang_id=True, pca_n_components=100))
...
dataset_list.append(Format_data(words_to_train, max_feat=None, dataset_name='Le - L - TF - 2g - PCA 500', n_gram=(1, 2), lemmatize=True, use_tf_idf=True, lang_id=True, pca_n_components=500))
